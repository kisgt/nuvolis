        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-red">
                    ...
                    <div class="num"> <?php echo count(get_all_students()); ?></div>
            ...
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-green">
                    ...
                    <div class="num"> <?php echo count(get_teachers()); ?></div>
            ...
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-aqua">
                    ...
                    <div class="num"> <?php echo count(get_parents()); ?>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-blue">
                    ...
                    <div class="num"><?php echo get_todays_total_attendance(); ?>
                    </div>
