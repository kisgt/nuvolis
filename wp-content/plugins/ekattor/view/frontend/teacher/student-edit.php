                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="date-and-time">
                                    <input type="text" name="birthday" value="<?php if ($row['birthday'] != '')echo date("D, d M Y", $row['birthday']);?>"
                                           class="form-control datepicker"  autocomplete="off" onclick="create_datepicker()">
                                </div>
                            </div>
                        </div>
