                    ...
                    <?php if ( isset ($_GET['exam_id']) && $_GET['exam_id'] > 0 && 
                        ...
                        <table class="table table-bordered" >
                            ...
                            <tbody>
                                ...
                                $query_result = $wpdb->get_results("SELECT * FROM $student WHERE username = '$current_user_name' ", ARRAY_A);
                                ...
                                foreach ($query_result as $row4) {
                                    ...
                                    <form method="post" action="<?php echo EKATTOR_BASE_URL; ?>&manager=marks" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(isset($row2['mark_obtained'])) echo $row2['mark_obtained']; else echo '-'; ?>
                                            </td>
                                            <td>
                                                <?php if(isset($row2['comment'])) echo $row2['comment']; else echo '-'; ?>
                                            </td>
                                        </tr>
                                    </form>
                                    <?php
