            ...
            <div class="panel-body">
                <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="class_id" class="form-control">
                                        ...
                                        <?php
                                        $classes = get_classes_for_parents_child();
                                ...
                                <td>
                                    <input type="submit" value="Show Attendance" class="btn btn-default" />
                                </td>
                            </tr>
                        </table>
                    </form>
                    ...
                    <?php if ( isset( $_GET['date']) && $_GET['date'] > 0 &&
                        ...
                        $students = get_students_for_parent( $_GET['class_id'] );
                                ...
                                foreach ( $students as $row ):
                                    ...
                                    <form action="<?php echo admin_url(); ?>admin-post.php" method="post"
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td>
                                                <select name="status" class="form-control" style="width:100px; float:left;" disabled>
