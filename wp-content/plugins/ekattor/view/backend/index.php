<?php 
    ...
    // Plugins header file 
    include ( EKATTOR_DIR . '/view/backend/header.php' ); 

    // Plugins navigation menu file. Depends on logged in user role.
    include ( EKATTOR_DIR . '/view/backend/' . $role . '/navigation.php' ); 
 
    // Plugins main body file. Depends on logged in user role.
    include ( EKATTOR_DIR . '/view/backend/' . $role . '/' . $manager . '.php' ); 

    // Plugins footer file.
    include ( EKATTOR_DIR . '/view/backend/footer.php' ); 
    
    // Modal popup file.
    include ( EKATTOR_DIR . '/view/backend/modal.php' ); 
